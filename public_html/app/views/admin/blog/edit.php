<?php $pageTitle = '编辑博客'; $activeMenu = 'blog'; ?>
<div class="max-w-5xl mx-auto space-y-4">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <h1 class="text-2xl font-bold text-gray-900">编辑博客</h1>
        <div class="flex gap-2 text-sm">
            <?php foreach ($supportedLangs as $l): ?>
            <a href="/admin/blog/edit/<?php echo rawurlencode($post['slug'] ?? ''); ?>?lang=<?php echo htmlspecialchars($l, ENT_QUOTES, 'UTF-8'); ?>"
