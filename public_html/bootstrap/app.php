...
/**
 * Runtime bootstrap: constants, errors, PSR-4-style autoload for App\, session.
 * Config and routing run from the front controller (index.php) after site.json exists.
 */
